...
class TaskManagerTest {
    ...
    void testSortTasksByPriority() {
        ...
        Task anotherMediumPriority = taskManager.addTask("Еще обычная", null, null, Task.Priority.MEDIUM);
        ...
        assertThat(sortedTasks.indexOf(highPriorityTask)).isLessThan(sortedTasks.indexOf(anotherHighPriority));
        assertThat(sortedTasks.indexOf(mediumPriorityTask)).isLessThan(sortedTasks.indexOf(anotherMediumPriority));
