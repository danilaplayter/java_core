...
public class CreditCalculator {
  ...
  public double calculateMonthlyPayment(double loanAmount, int loanTermMonths, String creditType,
    ...
    if (!(creditScore >= 750 && creditScore <= 850) && !(creditScore >= 650 && creditScore <= 749)
        && !(creditScore >= 500 && creditScore <= 649) && !(creditScore >= 300
        && creditScore <= 499)) {
      return -1;
    }
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Ежемесячный платёж: " + calculator.calculateMonthlyPayment(loanAmount, loanTermMonths,
