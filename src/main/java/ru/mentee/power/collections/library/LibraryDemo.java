...
public class LibraryDemo {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("978-3-16-148410-0", "The Great Gatsby", 1925, Book.Genre.FANTASY, List.of("F. Scott Fitzgerald"), true);
        Book book2 = new Book("978-0-06-112008-4", "To Kill a Mockingbird",1960, Book.Genre.DETECTIVE, List.of("Harper Lee"), false);
        Book book3 = new Book("978-0-545-01022-1", "Harry Potter and the Philosopher's Stone",  1997, Book.Genre.FANTASY, List.of("J.K. Rowling"),true);
        Book book4 = new Book("978-0-395-19395-7", "The Hobbit", 1937, Book.Genre.FANTASY, List.of("J.R.R. Tolkien"), false);
        Book book5 = new Book("978-1-4028-9462-6", "Clean Code", 2008, Book.Genre.TECHNICAL, List.of("Robert Martin"), true);
        Book book6 = new Book("978-0-13-235088-4", "Design Patterns", 1994, Book.Genre.TECHNICAL, List.of("Erich Gamma", "Richard Helm", "Ralph Johnson", "John Vlissides"),  true);
        ...
        Reader reader1 = new Reader("R001", "John Smith", "john.smith@example.com", Reader.ReaderCategory.STUDENT);
        Reader reader2 = new Reader("R002", "Alice Johnson", "alice.johnson@example.com", Reader.ReaderCategory.STUDENT);
        Reader reader3 = new Reader("R003", "Bob Wilson", "bob.wilson@example.com", Reader.ReaderCategory.STUDENT);
        ...
        sortedByYear.forEach(book -> System.out.println(book.getTitle() + " (" + book.getPublicationYear() + ")"));

        System.out.println("\n=== Books Sorted by Availability ===");
        List<Book> sortedByAvailability = library.sortBooksByAvailability(allBooks);
        sortedByAvailability.forEach(book -> System.out.println(book.getTitle() + " - Available: " + book.isAvailable()));
        ...
        Iterator<Book> genreYearIterator = library.getBooksByGenreAndYearIterator(Book.Genre.FANTASY, 1997);
