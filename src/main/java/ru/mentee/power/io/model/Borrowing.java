...
public class Borrowing implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(isbn, that.isbn) && Objects.equals(readerId, that.readerId)
  ...
  public String toString() {
    return "BookRecord" + "isbn='" + isbn + '\'' + ", readerId='" + readerId + '\''
        + ", borrowDate=" + borrowDate + ", returnDate=" + returnDate + ", dueDate=" + dueDate;
  }
}