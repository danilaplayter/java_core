...
public class LibraryPersistenceDemo {
    ...
    public static void main(String[] args) {
        ...
        if (libraryManager == null) {
            ...
            Reader reader = new Reader("ivanov", "Иван Иванов", "ivanov12345@gmai.com", Reader.ReaderCategory.STUDENT);
            ...
            if (Files.exists(Paths.get(BOOKS_CSV_IMPORT_FILE))) {
                int importedCount = libraryManager.importBooksFromCsv(BOOKS_CSV_IMPORT_FILE, CSV_DELIMITER, true);
                System.out.println("Импортировано книг: " + importedCount);
            } else {
                System.out.println("Файл для импорта " + BOOKS_CSV_IMPORT_FILE + " не найден. Импорт пропущен.");
            }
