    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (choice) {
                ...
                case 11:
                    taskManager.printTasks(taskManager.sortTasksByDueDate(), "Задачи, отсортированные по дате");
                    break;

                case 12: // Сортировка по приоритету
                    taskManager.printTasks(taskManager.sortTasksByPriority(), "Задачи, отсортированные по приоритету");
                    break;
