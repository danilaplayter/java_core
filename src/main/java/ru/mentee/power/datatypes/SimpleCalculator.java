...
public class SimpleCalculator {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("double -> int: " + doubleVar + " -> "
        + intFromDouble); // 2 так как при приведении типов int сохраняет число только до запятой
    System.out.println("int -> double: " + intVar + " -> "
        + doubleFromInt); // в java'е при приведении к double только первый элемент числа ставится перед точкой
    System.out.println("char + 1: " + charVar + " -> "
        + charFromInt); // после добавления единицы A превратилась в B так, как в таблице кодов A = 48, а В = 49
